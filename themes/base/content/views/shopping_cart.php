...
<?php } else { ?>
    <?php echo $form->open('shopping_cart', "action=update_product", true) ?>
        ...
        <div class="btn">
            ...
            <a class="btn" href="<?php echo $net->url('checkout.shipping', '', true) ?>"><?php _vzm("Checkout") ?></a>
        </div>
        <div>
            <a class="btn" href="<?php echo $net->url('shipping.estimator', '', true) ?>" onclick="popupWindow(this.href); return false;"><?php _vzm("Shipping Estimator") ?></a>
        </div>
